...
app.post("/evaluate", async (req, res) => {
  try {
    ...
    console.log(`Gemini response received, raw text length: ${rawText.length}`);
    ...
    console.log(`Successfully parsed Gemini response: score=${parsed.score}, maxScore=${parsed.maxScore}`);
