...
type Submission struct {
	...
	CohortType       string              `bson:"cohort_type,omitempty" json:"cohortType,omitempty"`
	...
	ExportBundlePath string              `bson:"export_bundle_path,omitempty" json:"-"`
	ExportBundleReady bool               `bson:"export_bundle_ready,omitempty" json:"exportBundleReady,omitempty"`
	ExportDownloadURL string             `bson:"-" json:"exportDownloadUrl,omitempty"`
}
