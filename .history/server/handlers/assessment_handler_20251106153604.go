...
func persistGeneratedAnswerKey(dir string, analysis *services.QuestionPaperAnalysis, cohortType, grade string, maxScore float64) (*models.AssetMeta, error) {
	if analysis == nil {
	...
	payload := map[string]any{
		...
		"cohortType": strings.TrimSpace(cohortType),
