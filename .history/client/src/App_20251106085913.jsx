...
function App() {
  ...
  setUploadState((prev) => ({ ...prev, error: null, message: null, bundleUrl: null }));
  ...
  const handleSubmission = async (event) => {
    ...
    setUploadState({ uploading: true, error: null, message: null, bundleUrl: null });
    ...
    try {
      ...
      if (!isBulk) {
        ...
        setUploadState({
          uploading: false,
          error: null,
          bundleUrl: data?.exportDownloadUrl || null,
  ...
  const bundleUrl = typeof data?.bundleDownloadUrl === "string" ? data.bundleDownloadUrl : null;
      ...
      setUploadState({ uploading: false, error: message, bundleUrl: null, message: null });
    }
  };
