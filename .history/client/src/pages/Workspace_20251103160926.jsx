      ...
      <header className="header">
        <div>
          ...
          <p className="subtitle">
            Configure your rubric and upload answer sheets to receive instant
            marks and reasoning.
          </p>
        </div>
      </header>
        ...
        <>
          <section className="card card--stretch">
            ...
            <form className="form form--vertical" onSubmit={handlePromptSubmit}>
              ...
              {promptStatus.error && (
                <p className="form__error">{promptStatus.error}</p>
              )}
              {promptStatus.message && (
                <p className="form__success">{promptStatus.message}</p>
              )}
                  ...
                  return (
                    <article key={submission.id} className="submission">
                      <header className="submission__header">
                        <div>
                          ...
                          {submission.title && submission.fileName && (
                            <p className="submission__subtitle">
                              {submission.fileName}
                            </p>
                          )}
                        </div>
                      ...
                      >
                        ...
                        <p>
                          {submission.reasoning || "No reasoning returned."}
                        </p>
                      </details>
