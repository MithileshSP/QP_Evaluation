    ...
    <div className="page">
      <header className="header">
        <div>
          ...
          <p className="subtitle">Upload your handwritten answers to see AI-generated marks.</p>
        </div>
                ...
                {submissions.map((submission) => (
                  <article key={submission.id} className="submission">
                    <header className="submission__header">
                      <h3 className="submission__title">{submission.fileName}</h3>
                      <span className="chip">
                    ...
                    <details className="submission__details" open={submission === latestSubmission}>
