      ...
      <form className="form" onSubmit={onSubmit}>
        ...
        {uploadMode === "bulk" && (
          <label className="form__label" htmlFor="bulkTitlePrefix">
            ...
            />
            <p className="form__hint">
              When set, files are named like “{form.titlePrefix || "Prefix"} 01”.
              Leave blank to use file names.
            </p>
          </label>
        )}

        <label className="form__label" htmlFor="submissionFile">
          {uploadMode === "bulk" ? "Upload answer scripts" : "Upload answer script"}
          <input
            key={fileInputKey}
            id="submissionFile"
            name={fileInputName}
