...
export default function EvaluationCard({
  ...
  const [expandedState, setExpandedState] = useState(Boolean(defaultOpen));
  ...
  const expanded = isCollapsible ? expandedState : true;
      ...
      <header className="evaluation-card__header">
        ...
        <div className="evaluation-card__score">
          <span className="evaluation-card__score-value">
            {formatScore(resolvedScores.score)} /{" "}
            {formatScore(resolvedScores.maxScore)}
          </span>
