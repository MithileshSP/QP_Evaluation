      ...
      <form className="form" onSubmit={handleSubmit}>
        ...
        <label className="form__label" htmlFor="assessmentGrade">
          ...
          <input
            ...
            className="form__input"
            type="text"
            placeholder="e.g. Grade 6, First Year B.Tech, Semester 3"
            value={form.grade}
            onChange={handleInputChange}
            list="assessmentGradeSuggestions"
            required
          />
          <datalist id="assessmentGradeSuggestions">
          ...
          <p className="form__hint">
            Enter any label that fits your learners—school grades, college years,
            departments, or custom cohorts.
          </p>
        </label>
