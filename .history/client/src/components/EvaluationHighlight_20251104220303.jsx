...
export default function EvaluationHighlight({ submission, loading }) {
  const [activeSubmission, setActiveSubmission] = useState(null);

  if (loading) {
    return (
      <section className="panel panel--full highlight">
      ...
      <section className="panel panel--full highlight">
        <header className="panel__heading highlight__header">
          <div>
            ...
            <p className="panel__meta">
              Upload an answer sheet to see the freshest evaluation summary here.
            </p>
          </div>
        </header>
      </section>
        ...
        <div className="highlight__tags">
          ...
          {submission.maxScore && (
            <span className="highlight__tag highlight__tag--muted">
              Max {Number(submission.maxScore).toFixed(1)}
            </span>
          )}
        </div>
      )}
